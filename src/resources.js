...
export const RECURSOS = {
  ...
  clientes: {
    ...
    singular: 'Cliente',
    icono: '👥',
    descripcion: 'Personas que hacen pedidos en la pastelería, sus direcciones de entrega y productos ordenados.',
    campos: [
      ...
      { name: 'pedido', label: 'Último pedido / Productos', tipo: 'text', placeholder: 'Ej. 2x Pastel de pollo, 1x Buñuelo', completo: true },
    ...
    columnas: [
      ...
      { campo: 'pedido', titulo: 'Pedido / Productos', tipo: 'productos' },
  ...
  ordenes: {
    ...
    singular: 'Orden',
    icono: '🧾',
    descripcion: 'Pedidos registrados con el nombre del cliente, dirección de entrega y detalle de productos.',
    campos: [
      { name: 'cliente', label: 'Cliente', tipo: 'select', origen: 'clientes', requerido: true },
      { name: 'direccion', label: 'Dirección de entrega', tipo: 'text', placeholder: 'Ej. Calle 10 #20-30', completo: true },
    ...
    columnas: [
      ...
      { campo: 'direccion', titulo: 'Dirección' },
      { campo: 'productos', titulo: 'Pedido / Productos', tipo: 'productos' },
      { campo: 'total', titulo: 'Total', tipo: 'precio' },
      { campo: 'fecha', titulo: 'Fecha', tipo: 'fecha' },
      { campo: 'estado', titulo: 'Estado', tipo: 'estado-interactivo' },
